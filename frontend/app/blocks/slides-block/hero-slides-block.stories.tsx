    ...
    slides: [
      {
        ...
        overlayTitle: {
          show: true,
          text: richText(simpleElement("paragraph", text("Lost City"))),
          position: "top-right",
      ...
      },
      {
        ...
        overlayTitle: {
          show: true,
          text: richText(simpleElement("paragraph", text("Parque Tayrona"))),
      ...
      },
      {
        ...
        overlayTitle: {
          show: true,
          text: richText(simpleElement("paragraph", text("Santa Marta"))),
      ...
      },
      {
        ...
        overlayTitle: {
          show: true,
          text: richText(simpleElement("paragraph", text("Minca"))),
          position: "top-left",
          cta: callToAction("Read More", "primary"),
        },
      },
