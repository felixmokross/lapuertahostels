...
export function MaintenanceScreen({ message }: MaintenanceScreenProps) {
  return (
    <main className="flex h-screen items-center justify-center bg-gradient-to-br text-center text-4xl font-light tracking-tighter text-neutral-800 sm:text-6xl">
