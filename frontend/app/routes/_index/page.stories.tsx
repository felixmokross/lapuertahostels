        ...
        text: [
          {
            children: [
              { text: "Step into our " },
              { text: "Santa Marta haven,", bold: true },
              { text: " where the " },
              {
          ...
          { children: [{ text: "" }] },
          {
            children: [
              ...
              { text: "deep love for Santa Marta,", bold: true },
              {
